...
\begin{tikzpicture}[scale=1, node distance = 2cm, auto]
       ...
       \node [block, above of=geoI, node distance=4.5cm] (malla) {Discretizaci\'on del volumen de control};
	   ...
	   \node [decision, right of=cfd, node distance=4cm] (res) {?`Error mayor al $3.5 \%$?};
